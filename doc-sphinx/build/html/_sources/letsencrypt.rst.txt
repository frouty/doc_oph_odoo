...
Je me demande si ce n'est pas un probleme de certificat. J'envisage d'utiliser letsencrypt. Mais je ne sais pas si cela va régmer le problème.
...
accepts the risk and continue et c'est bon.
   ...
   - 4 avec chrome j'ai This site can’t provide a secure connection kuendu.ddns.net uses an unsupported protocol.
...
Depuis Firefox 78 le minimum TLS est TLS 1.2. Ma version de nginx (1.6) ne supporte pas le TLSv1.3
