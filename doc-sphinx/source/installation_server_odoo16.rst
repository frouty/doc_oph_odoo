...
Create a log directory, change owner  and set permissions
---------------------------------------------------------
::
...
J'ai pas d'application avec ce nouveau user.  Je me logue à nouveau sous admin pour installer des apps.
